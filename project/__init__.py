...
csrf_protection = CSRFProtect()  # NEW!!
login = LoginManager()            # NEW!!
login.login_view = "users.login"  # NEW!!
mail = Mail()
...
def register_blueprints(app):
    ...
    # los blueprint se importan aqui para evitar referencias circulares
...
def initialize_extensions(app):
    ...
    csrf_protection.init_app(app)  # NEW!!
