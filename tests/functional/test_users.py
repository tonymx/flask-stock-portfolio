...
def test_valid_registration(test_client):
    ...
    with mail.record_messages() as outbox:
        ...
        assert outbox[0].sender == 'consultormid@gmail.com'
...
def test_user_profile_logged_in(test_client, log_in_default_user):
    ...
    """
    #se asume que el usuario default, no ha confirmado su email
...
def test_get_password_reset_via_email_page(test_client):
    """
    GIVEN a Flask application configured for testing
    WHEN the '/users/reset/' page is is requested (GET) 
    THEN check that the page is succesfully returned
    """
...
def test_post_password_reset_via_email_page_valid(test_client, confirm_email_default_user):
    ...
    with mail.record_messages() as outbox:
        ...
        assert 'consultormid@gmail.com' in outbox[0].html
...
#Pruebas seccion "Change Password"
